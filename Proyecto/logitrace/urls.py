...
urlpatterns = [
    path('login/', LoginView.as_view(template_name='registration/login.html',authentication_form=views.LogiTraceAuthenticationForm), name='login'),
    ...
    path('ui/ingress/create/', views.ingress_create_view, name='ingress-create-ui'),
    path('ui/adjustments/', views.adjustments_view, name='adjustments-ui'),
    path('ui/adjustments/create/', views.adjustments_create_view, name='adjustments-create-ui'),
    path('ui/transfers/', views.transfers_view, name='transfers-ui'),
    path('ui/transfers/create/', views.transfers_create_view, name='transfers-create-ui'),
    ...
    path('ui/orders/create/', views.orders_create_view, name='orders-create-ui'),
    path('ui/products/', views.products_view, name='products-ui'),
    path('ui/products/create/', views.products_create_view, name='products-create-ui'),
    path('ui/users/', views.users_view, name='users-ui'),
    path('ui/locations/', views.locations_view, name='locations-ui'),
    path('ui/settings/', views.settings_view, name='settings'),
    ...
    path('ui/registration/', views.registration_view, name='registration-ui'),
]
